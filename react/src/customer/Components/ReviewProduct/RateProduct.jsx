...
const RateProduct = () => {
  ...
  const handleSubmit = (event) => {
    ...
    let review = document.getElementById("cmt-title").value;
    if (!review) {
    ...
    dispatch(createReview({review:review,productId}))
      ...
      <Grid sx={{ justifyContent: "space-between" }} container>
        ...
        >
          ...
          <div className="ml-3 lg:ml-5 space-y-2 lg:space-y-4">
            ...
            <p className='opacity-50 line-through'>{customersProduct.product?.price}đ</p>
            <p className='text-green-600 font-semibold'>{customersProduct.product?.discountedPrice}đ</p>
            {/* <p>Size: Free</p> */}
