    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          <a href="/home">
            <Avatar alt="Zosh" src="https://scontent.fhph1-2.fna.fbcdn.net/v/t1.6435-9/125082636_115596410363056_1631769330448288504_n.png?_nc_cat=106&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeGgP-oZOTYeuNVwKi-SAERI1LbVYuab-evUttVi5pv5657FZd8ogjn9NxjmAfFhG3N73g1KL-v2QaIGt_xF6m_I&_nc_ohc=L66puMGw9-EQ7kNvgFqdKue&_nc_ht=scontent.fhph1-2.fna&oh=00_AfDzq0H9QHVPloJKWYOw2Qym8ySDrUenI23deqSUogWjCw&oe=665450C3" />
          </a>
          {/* <Search>
            <SearchIconWrapper>
              <SearchIcon />
