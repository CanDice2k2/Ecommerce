...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("SELECT p From Product p where LOWER(p.title) Like %:query% OR LOWER(p.brand) LIKE %:query% OR LOWER(p.category.name) LIKE %:query%")
